...
${OBJECTDIR}/src/Engine/Game.o: src/Engine/Game.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Engine/Game.o src/Engine/Game.cpp

${OBJECTDIR}/src/Engine/Log.o: src/Engine/Log.cpp
	${MKDIR} -p ${OBJECTDIR}/src/Engine
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Engine/Log.o src/Engine/Log.cpp

${OBJECTDIR}/src/Graphics/ConsoleSprite.o: src/Graphics/ConsoleSprite.cpp
	${MKDIR} -p ${OBJECTDIR}/src/Graphics
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Graphics/ConsoleSprite.o src/Graphics/ConsoleSprite.cpp

${OBJECTDIR}/src/Graphics/Frame.o: src/Graphics/Frame.cpp
	${MKDIR} -p ${OBJECTDIR}/src/Graphics
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Graphics/Frame.o src/Graphics/Frame.cpp
